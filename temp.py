    ...
    def handle(self):
 	...
 	#Split up the first line of the request
	    ...
	    #Within WWW directory and end in /
            ...
            #Within WWW directory and does not end with /
	    else:
                print ("Got into here")
      		user_path = user_path + "/index.html"
	      	openfile = open(user_path)
        ...
        # New code to handle /WWW/
      	...
      	elif (user_path.startswith("/www/" and len(user_path) > 5)):
      	    user_path.replace("/www/","")
